...
Parse.Cloud.define('saveMessage', function(request, response) {
    ...
    messageObject.set('sentBy', {'__type': 'Pointer', 'className':'User', 'objectId': message.sentBy});
    messageObject.set('sentTo', {'__type': 'Pointer', 'className':'User', 'objectId': message.sentTo});
